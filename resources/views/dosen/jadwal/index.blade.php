...
<div class="container py-4">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form method="GET" action="{{ route('dosen.jadwal.index') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end">
                    ...
                    <a href="{{ route('dosen.jadwal.index') }}" class="btn btn-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('dosen.presensi.by-jadwal', $j->id) }}" class="btn btn-sm btn-info">Presensi</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
